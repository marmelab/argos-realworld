      ...
      <div class="col-md-6 offset-md-3 col-xs-12">
        ...
        <form>
          <fieldset>
              ...
              <button id="update-button" class="btn btn-lg btn-primary pull-xs-right data-test-id="update-settings-button">
                Update Settings
              </button>
          </fieldset>
        </form>
        <hr>
        <button id="logoutButton" class="btn btn-outline-danger" data-test-id="logout-button">Or click here to logout.</button>
      </div>
