...
export class CNavComponent extends HTMLElement {
    ...
    createProfileLinks(user) {
        let newArticle = this.createNavItemLink('#/editor', '<i class="ion-compose"></i>&nbsp;New Post','new-post-menu');
        this.$navUl.appendChild(newArticle);

        let settings = this.createNavItemLink('#/settings', '<i class="ion-gear-a"></i>&nbsp;Settings', 'settings-menu');
        this.$navUl.appendChild(settings);

        let userProfile = this.createNavItemLink('#/profile/' + user.username, user.username, 'user-menu');
    ...
    createNavItemLink(href, content, datatestid) {
        ...
        aNavLink.setAttribute( "data-test-id", datatestid);
         ...
         <nav class="navbar navbar-light">
            <div class="container">
                ...
                <ul class="nav navbar-nav pull-xs-right">
                    <li class="nav-item">
                        <a href="#/" data-navigo class="nav-link" data-test-id="home-menu">Home</a>
                    </li>
                    <li id="signin" class="nav-item">
                        <a href="#/login" data-navigo class="nav-link" data-test-id="signin-menu">Sign in</a>
                    </li>
                    <li id="signup" class="nav-item">
                        <a href="#/register" data-navigo class="nav-link" data-test-id="signup-menu">Sign up</a>
                    </li>
                </ul>
            </div>
        </nav>
